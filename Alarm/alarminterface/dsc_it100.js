...
// List of function used to send the action to DSC-IT100 Alarm Board
//////////////////////////////////////////////////////////////////////////////////////
...
function parseReceivedData(data) {
    ...
    responseHandler = command_map[code]['handler'];
...
// codes that need a special parser
/*
...
500 // we don't need this because otherwise would be handling all Acknowledgement commands
50003129 - Alarm command 031 means stay
5000332B - Alarm command 033 means arm with code but with delay entry
50003028 - Alarm command 030 means away
50004029 - Alarm command 040 means disarm
*/
